...
class websiteManage extends Component {
  constructor(props) {
    ...
    this.columns = [{
      ...
      key: 'websiteType',
      render: websiteType => {
        return websiteType === 'internal' ? '内部网站' : '外部网站';
      }
    }, {
      title: '描述',
      dataIndex: 'content',
          ...
          <Layout style={{ background: '#fff' }}>
            <Sider width={250} style={{ overflow: 'auto', background: '#fff', borderRight: '10px solid #f0f2f5' }}>
              <div className="orglist">
                <ContentList type="website" select={this.selectImgList} />
              </div>
            </Sider>
            <div style={{ width: '100%', padding: '15px' }}>
              ...
              />
              <AddContent type="website" id={categoryId} onRef={ref => { this.$addContent = ref; }} onOK={() => this.getInfoList('1', '10', categoryId)} />
              <EditContent type="website" id={categoryId} onRef={ref => { this.$editContent = ref; }} onOK={() => this.getInfoList(current, '10', categoryId)} />
              <EditResource type="website" onRef={ref => { this.$editResource = ref; }} onOK={() => this.getInfoList(current, '10', categoryId)} />
            </div>
          </Layout>
        </Content>
      </Layout>
