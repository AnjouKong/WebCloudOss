        ...
        <Content style={{ background: '#fff', padding: 24, margin: 0, minHeight: 280 }}>
          <Layout style={{ background: '#fff' }}>
            ...
            <div style={{ width: '100%', padding: '15px' }}>
              ...
              />
              <AddContent type="theme" id={categoryId} onRef={ref => { this.$addContent = ref; }} onOK={() => this.getInfoList('1', '10', categoryId)} />
              <EditContent type="theme" id={categoryId} onRef={ref => { this.$editContent = ref; }} onOK={() => this.getInfoList(current, '10', categoryId)} />
              <EditResource type="theme" onRef={ref => { this.$editResource = ref; }} onOK={() => this.getInfoList(current, '10', categoryId)} />
            </div>
          </Layout>
        </Content>
      </Layout>
