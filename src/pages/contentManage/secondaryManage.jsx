...
class secondaryManage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      current: 1,
        ...
        <span>
          {
            ...
            <Link to={{ pathname: '/contentManage/secondaryPage', query: { id: record.key } }}>配置场景</Link>
          }
          {
        ...
        <Content style={{ background: '#fff', padding: 24, margin: 0, minHeight: 280 }}>
          <Layout style={{ background: '#fff' }}>
            ...
            <div style={{ width: '100%', padding: '15px' }}>
              ...
              />
              <AddContent type="secondary" id={categoryId} onRef={ref => { this.$addContent = ref; }} onOK={() => this.getInfoList('1', '10', categoryId)} />
              <EditContent type="secondary" id={categoryId} onRef={ref => { this.$editContent = ref; }} onOK={() => this.getInfoList(current, '10', categoryId)} />
              <EditResource type="secondary" onRef={ref => { this.$editResource = ref; }} onOK={() => this.getInfoList(current, '10', categoryId)} />
            </div>
          </Layout>
        </Content>
      </Layout>
...
export default secondaryManage;
