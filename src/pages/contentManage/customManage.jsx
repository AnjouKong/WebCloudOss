...
class customManage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      current: 1,
        ...
        <span>
          {
            ...
            <Link to={{ pathname: '/contentManage/customPage', query: { id: record.key } }}>配置场景</Link>
          }
          {
          ...
          <Layout style={{ background: '#fff' }}>
            <Sider width={250} style={{ overflow: 'auto', background: '#fff', borderRight: '10px solid #f0f2f5' }}>
              <div className="orglist">
                <ContentList type="custom" select={this.selectImgList} />
              </div>
            </Sider>
            <div style={{ width: '100%', padding: '15px' }}>
              ...
              />
              <AddContent type="custom" id={categoryId} onRef={ref => { this.$addContent = ref; }} onOK={() => this.getInfoList('1', '10', categoryId)} />
              <EditContent type="custom" id={categoryId} onRef={ref => { this.$editContent = ref; }} onOK={() => this.getInfoList(current, '10', categoryId)} />
              <EditResource type="custom" onRef={ref => { this.$editResource = ref; }} onOK={() => this.getInfoList(current, '10', categoryId)} />
            </div>
          </Layout>
        </Content>
      </Layout>
